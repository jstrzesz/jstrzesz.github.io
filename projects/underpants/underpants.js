...
_.filter = function(collection, test){
    // create output array //
    // loop through original array using each, design a function passed to each://
    // > the function must run the test, inspect the result
    // > of the test, determine if value has passed the test //
    // if value passed test, pust to output array//
    // return output array //
    const output = [];
...
_.unique = function(array){
   ...
   _.each(array, function(element, index, array){
         if(_.indexOf(duplicatesRemoved, element, array) === -1) {
